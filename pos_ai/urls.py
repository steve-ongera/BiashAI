...
urlpatterns = [
    ...
    path(
        'customer/transactions/<uuid:transaction_id>/',
    ...
    path(
        'customer/payments/delete/<uuid:account_id>/',
        views.delete_payment_account,
    ...
    # Shopping Session
    path(
        'shop/session/start/<uuid:store_id>/',
        views.start_shopping_session,
        name='start_shopping_session'
    ),
    path(
        'shop/session/<uuid:session_id>/',
        views.shopping_session,
        name='shopping_session'
    ),

    # Cart
    path(
        'shop/session/<uuid:session_id>/add/<uuid:product_id>/',
        views.add_to_cart,
        name='add_to_cart'
    ),
    path(
        'shop/session/<uuid:session_id>/update/<uuid:cart_item_id>/',
        views.update_cart_item,
        name='update_cart_item'
    ),
    path(
        'shop/session/<uuid:session_id>/remove/<uuid:cart_item_id>/',
    ...
    # Checkout
    path(
        'shop/session/<uuid:session_id>/checkout/',
        views.checkout,
        name='checkout'
    ),
    ...
    path(
        'dashboard/stores/<uuid:store_id>/inventory/',
        views.manage_inventory,
    ...
    path(
        'api/v1/stores/<uuid:store_id>/status/',
        views.api_store_status,
        name='api_store_status'
    ),

    path(
        'api/v1/products/<uuid:product_id>/availability/<uuid:store_id>/',
        views.api_product_availability,
        name='api_product_availability'
    ),
]
